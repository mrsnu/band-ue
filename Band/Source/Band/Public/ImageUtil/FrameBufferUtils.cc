...
BoundingBox OrientAndDenormalizeBoundingBox(
    ...
    BoundingBox from_box{
        from_left * from_dimension.width,
        from_top * from_dimension.height,
        round(abs(from_right - from_left) * from_dimension.width),
...
OrientParams GetOrientParams(FrameBuffer::Orientation from_orientation,
  ...
  _ASSERT(from_index > -1 && to_index > -1);
